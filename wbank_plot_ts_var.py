...
PLOT_TS = +1;
if(PLOT_TS > 0):
    simList=["fileSimX.csv_fine",  "fileSimX.csv"]
    obsList=["fileObsX.csv_fine",  "fileObsX.csv"]
else: # box plots
    simList=["./sc_000_bsln2/fileSimX.csv"]
    obsList=["./sc_000_bsln2/fileObsX.csv"]
...
# read scenarios
dataFile1 = "./sc_100_FJI2/fileSimX.csv"
dfData_1 = pd.read_csv(dataFile1, sep=' ', header=0)
dataFile2 = "./sc_100_CAF2/fileSimX.csv"
dfData_2 = pd.read_csv(dataFile2, sep=' ', header=0)
dataFile3 = "./sc_100_AUS2/fileSimX.csv"
dfData_3 = pd.read_csv(dataFile3, sep=' ', header=0)
dataFile4 = "./sc_010_AUS2/fileSimX.csv"
dfData_4 = pd.read_csv(dataFile4, sep=' ', header=0)
#dataFile5 = "./sc_100_AUS2/fileSimX.csv"
#dfData_5 = pd.read_csv(dataFile5, sep=' ', header=0)
#dataFile6 = "./sc_010_AUS2/fileSimX.csv"
#dfData_6 = pd.read_csv(dataFile6, sep=' ', header=0)
...
if(PLOT_TS < 0):
    ...
    for i, c in enumerate(df_mean.columns):
        ...
        dfData_colx = dfData.loc[:,[cc]]
        dfData_col = dfData_colx.rename(columns={cc:cc0}, inplace=False)

        dfData_col[cc1] = dfData_1[cc]
        dfData_col[cc2] = dfData_2[cc]
        dfData_col[cc3] = dfData_3[cc]
        dfData_col[cc4] = dfData_4[cc]
        #dfData_col[cc5] = dfData_5[cc]
        #dfData_col[cc6] = dfData_6[cc]

        box_colors = {cc0: 'aqua', cc1: 'gold', cc2: 'red',  cc3: 'limegreen', cc4: 'mediumpurple'}

        ax = sns.boxplot(data=dfData_col, showfliers = False, palette=box_colors)
